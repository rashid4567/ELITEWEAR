...
router.get(
  "/customers/:id/wallet",
  adminAuth,
  customerController.getCustomerWallet
);
...
router.post("/addBanner", adminAuth, BannerController.addBanner);
router.get("/editBaner", adminAuth, BannerController.getEditBanner);
router.post("/editBaner", adminAuth, BannerController.updateBanner);
router.get("/deleteBaner", adminAuth, BannerController.deleteBanner);
router.get("/api/banners", adminAuth, BannerController.getAllBanners);
router.get("/api/banners/:id", adminAuth, BannerController.getBannerById);
router.post(
...
router.get(
  "/invoices/:id",
  adminAuth,
  adminorderController.admindownloadInvoice
);
router.get(
  "/orders/item/:orderItemId/can-update",
  adminAuth,
  adminorderController.checkItemUpdateability
);
router.get(
  "/orders/:orderId/can-update",
  adminAuth,
  adminorderController.checkOrderUpdateability
);
router.post(
  "/orders/item/:orderItemId/update-status",
  adminAuth,
  adminorderController.updateOrderItemStatus
);
router.post(
  "/orders/item/:orderItemId/approve-return",
  adminAuth,
  adminorderController.approveReturnItem
);
router.post(
  "/orders/item/:orderItemId/complete-return",
  adminAuth,
  adminorderController.completeReturnItem
);
router.post(
  "/orders/item/:orderItemId/reject-return",
  adminAuth,
  adminorderController.rejectReturnItem
);
...
router.get(
  ...
  adminAuth,
  salesontroller.downloadSalesExcel
);
...
router.get(
  "/wallet-transactions",
  adminAuth,
  adminWalletController.getAllWalletTransactions
);
router.get(
  "/refund-transactions",
  adminAuth,
  adminWalletController.getRefundTransactions
);
router.get(
  "/user-wallet/:userId",
  adminAuth,
...
router.get(
  "/refund-statistics",
  adminAuth,
  adminWalletController.getRefundStatistics
);
router.post(
  "/process-manual-refund",
  adminAuth,
  adminWalletController.processManualRefund
);
router.get(
  "/refund-details/:transactionRef",
  adminAuth,
  adminWalletController.getRefundDetails
);
...
router.get("/error-404", adminControll.adminNotFound);
...
router.get("*", (req, res, next) => {
  ...
  try {
    adminControll.adminNotFound(req, res);
  } catch (error) {
